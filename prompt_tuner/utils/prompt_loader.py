    ...
    def load(self, name: str, use_cache: bool = True) -> str:
        ...
        if not os.path.exists(file_path):
            ...
            alt_paths = [
                ...
                os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "prompts", f"{name}.prompt"),  # Package prompts dir
            ]
            ...
            for alt_path in alt_paths:
                ...
                raise FileNotFoundError(f"Prompt template not found: {file_path}. Also tried: {alt_paths}")
